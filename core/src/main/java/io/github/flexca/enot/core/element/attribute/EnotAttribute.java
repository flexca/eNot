package io.github.flexca.enot.core.element.attribute;
...
/**
 * Defines a contract for an attribute key used in an {@link io.github.flexca.enot.core.element.EnotElement}.
 * <p>
 ...
 *
 * @see io.github.flexca.enot.core.element.EnotElement#getAttributes()
 */
public interface EnotAttribute {
     ...
     * <p>
     * The {@link io.github.flexca.enot.core.parser.EnotParser} uses this to validate that the value
