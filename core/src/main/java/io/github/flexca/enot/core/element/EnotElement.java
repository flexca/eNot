package io.github.flexca.enot.core.element;
...
public class EnotElement {
    ...
    /**
     * The type identifier for the element. This string is used by the {@link EnotRegistry}
     * to look up the corresponding {@link EnotTypeSpecification} that defines
     ...
     *     an {@link EnotSerializationException} is thrown.
     ...
     * and its corresponding {@link EnotTypeSpecification}.
     */
    private Object body;
